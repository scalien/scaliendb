...
class scaliendb_clientPINVOKE {
  ...
  public static extern int SDBP_GetCStr(HandleRef jarg1, IntPtr jarg2, int jarg3);
  ...
  public static extern int SDBP_SetCStr(HandleRef jarg1, IntPtr jarg2, int jarg3, IntPtr jarg4, int jarg5);
  ...
  public static extern int SDBP_SetIfNotExistsCStr(HandleRef jarg1, IntPtr jarg2, int jarg3, IntPtr jarg4, int jarg5);
  ...
  public static extern int SDBP_TestAndSetCStr(HandleRef jarg1, IntPtr jarg2, int jarg3, IntPtr jarg4, int jarg5, IntPtr jarg6, int jarg7);
  ...
  public static extern int SDBP_GetAndSetCStr(HandleRef jarg1, IntPtr jarg2, int jarg3, IntPtr jarg4, int jarg5);
  ...
  public static extern int SDBP_AddCStr(HandleRef jarg1, IntPtr jarg2, int jarg3, long jarg4);
  ...
  public static extern int SDBP_AppendCStr(HandleRef jarg1, IntPtr jarg2, int jarg3, IntPtr jarg4, int jarg5);
  ...
  public static extern int SDBP_DeleteCStr(HandleRef jarg1, IntPtr jarg2, int jarg3);
  ...
  public static extern int SDBP_TestAndDeleteCStr(HandleRef jarg1, IntPtr jarg2, int jarg3, IntPtr jarg4, int jarg5);
  ...
  public static extern int SDBP_RemoveCStr(HandleRef jarg1, IntPtr jarg2, int jarg3);
  ...
  public static extern int SDBP_ListKeysCStr(HandleRef jarg1, IntPtr jarg2, int jarg3, IntPtr jarg4, int jarg5, IntPtr jarg6, int jarg7, uint jarg8, bool jarg9);
  ...
  public static extern int SDBP_ListKeyValuesCStr(HandleRef jarg1, IntPtr jarg2, int jarg3, IntPtr jarg4, int jarg5, IntPtr jarg6, int jarg7, uint jarg8, bool jarg9);
  ...
  public static extern int SDBP_CountCStr(HandleRef jarg1, IntPtr jarg2, int jarg3, IntPtr jarg4, int jarg5, IntPtr jarg6, int jarg7);
