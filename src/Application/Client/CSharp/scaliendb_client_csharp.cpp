...
SWIGEXPORT void SWIGSTDCALL CSharp_SDBP_Buffer_data_set(void * jarg1, intptr_t jarg2) {
  SDBP_Buffer *arg1 = (SDBP_Buffer *) 0 ;
  intptr_t arg2 ;
...
SWIGEXPORT intptr_t SWIGSTDCALL CSharp_SDBP_Buffer_data_get(void * jarg1) {
  intptr_t jresult ;
  SDBP_Buffer *arg1 = (SDBP_Buffer *) 0 ;
  intptr_t result;
...
SWIGEXPORT unsigned long long SWIGSTDCALL CSharp_SDBP_ResultNodeID(void * jarg1) {
  unsigned long long jresult ;
  ResultObj arg1 = (ResultObj) 0 ;
  uint64_t result;
  
  arg1 = (ResultObj)jarg1; 
  result = (uint64_t)SDBP_ResultNodeID(arg1);
  jresult = result; 
  return jresult;
}
