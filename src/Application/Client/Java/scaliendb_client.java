...
public class scaliendb_client {
  ...
  public static int SDBP_SetCStr(SWIGTYPE_p_void client_, byte[] key_, int lenKey, byte[] value_, int lenValue) {
    return scaliendb_clientJNI.SDBP_SetCStr(SWIGTYPE_p_void.getCPtr(client_), key_, lenKey, value_, lenValue);
  }
  ...
  public static int SDBP_SetIfNotExistsCStr(SWIGTYPE_p_void client_, byte[] key_, int lenKey, byte[] value_, int lenValue) {
    return scaliendb_clientJNI.SDBP_SetIfNotExistsCStr(SWIGTYPE_p_void.getCPtr(client_), key_, lenKey, value_, lenValue);
  }
  ...
  public static int SDBP_TestAndSetCStr(SWIGTYPE_p_void client_, byte[] key_, int lenKey, byte[] test, int lenTest, byte[] value_, int lenValue) {
    return scaliendb_clientJNI.SDBP_TestAndSetCStr(SWIGTYPE_p_void.getCPtr(client_), key_, lenKey, test, lenTest, value_, lenValue);
  }
  ...
  public static int SDBP_AddCStr(SWIGTYPE_p_void client_, byte[] key_, int len, long number) {
    return scaliendb_clientJNI.SDBP_AddCStr(SWIGTYPE_p_void.getCPtr(client_), key_, len, number);
  }
  ...
  public static int SDBP_DeleteCStr(SWIGTYPE_p_void client_, byte[] key_, int len) {
    return scaliendb_clientJNI.SDBP_DeleteCStr(SWIGTYPE_p_void.getCPtr(client_), key_, len);
  }
  ...
  public static int SDBP_RemoveCStr(SWIGTYPE_p_void client_, byte[] key_, int len) {
    return scaliendb_clientJNI.SDBP_RemoveCStr(SWIGTYPE_p_void.getCPtr(client_), key_, len);
  }
