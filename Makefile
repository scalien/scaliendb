...
javadoc: $(JAVA_SOURCE_FILES) 
	-SRCDIR=`pwd`; cd $(SRC_DIR)/$(JAVA_CLIENT_DIR) && javadoc -d $$SRCDIR/javadoc -public Client.java Database.java ListParams.java Quorum.java Result.java SDBPException.java Status.java Table.java StringRangeParams.java ByteRangeParams.java
